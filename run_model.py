...
from allometry.model_util import MODELS, get_model
...
def get_loader(args, path):
    ...
    sheet_dataset = AllometrySheet(path, rotate=args.rotate_images)
...
def parse_args():
    ...
    arg_parser.add_argument(
        ...
        type=Path, help="""The directory containing the images to convert. They
    ...
    arg_parser.add_argument(
        '--rotate-images', type=int, default=0,
